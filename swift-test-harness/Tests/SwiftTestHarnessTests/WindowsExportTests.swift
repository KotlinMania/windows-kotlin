...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Windows.swiftmodule/`
...
//      `import Windows` above would fail at compile time.
//
//   2. The static archive `libWindows.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Windows" }` and
//      `flattenPackage = "io.github.kotlinmania.windows"` configuration in
...
//      via the `WindowsLibrary` product.
//
