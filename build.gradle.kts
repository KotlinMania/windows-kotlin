...
kotlin {
    ...
    val xcf = XCFramework("Windows")

    macosArm64 {
        binaries.framework { baseName = "Windows"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Windows"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Windows"
        flattenPackage = "io.github.kotlinmania.windows"
    }

    android {
        namespace = "io.github.kotlinmania.windows"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "windows-kotlin", version.toString())

    pom {
        name.set("windows-kotlin")
        description.set("Kotlin Multiplatform port of microsoft/windows-rs - Rust for Windows")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/windows-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/windows-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/windows-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/windows-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.windows.codeql
