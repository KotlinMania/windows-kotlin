...
This file is the quick-reference operating contract for windows-kotlin. The longer
...
windows-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`windows`](https://crates.io/crates/windows). Upstream Rust is the behavioral oracle while the
